            ...
            <div class="modal-content">
                ...
                <form action="{{ route('polylines.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Image</label>
                            <input class="form-control" type="file" id="image" name="image" onchange="document.getElementById('preview-image-polylines').src = window.URL.createObjectURL(this.files[0])">
    ...
    <div class="modal" tabindex="-1" id="modalInputPolygon"> <!-- ID Diperbaiki -->
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('polygons.store') }}" method="post" enctype="multipart/form-data"> <!-- Route Diperbaiki -->
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label">Name</label>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Image</label>
                            <input class="form-control" type="file" id="image" name="image" onchange="document.getElementById('preview-image-polygon').src = window.URL.createObjectURL(this.files[0])">
...
@section('scripts')
    ...
    <script>
        ...
        var points = L.geoJSON(null, {
            ...
            '@csrf' +
            '@method("delete")' +
            "<button type='submit' class='btn btn-sm btn-danger' title='Delete feature' onclick='return confirm(`Are you sure to delete this feature`)'><i class='fa fa-trash'></i></button>" +
            "</form>"
            ;
        ...
        var polylines = L.geoJSON(null, {
            ...
            "Deskripsi: " + feature.properties.description + "<br>" +
            "Dibuat: " + feature.properties.created_at + "<br>" +
            "<img src='{{ asset('storage/images') }}/" + feature.properties.image + "' alt='' class='img-thumbnail' width='400'>"+ "<br>" +
            "<form action='" + routedelete + "' method='post'>" +
            '@csrf' +
            '@method("delete")' +
            "<button type='submit' class='btn btn-sm btn-danger' title='Delete feature' onclick='return confirm(`Are you sure to delete this feature`)'><i class='fa fa-trash'></i></button>" +
